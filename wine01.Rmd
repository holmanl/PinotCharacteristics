...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We conducted a study on Pinot-Noir type wine. In particular, we tackled two questions of interest regarding said wine - whether or not the quality of wine can be predicted from the region it originates from and whether or not certain key characteristics of the wine can determine its quality.
  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Since "quality" is a rating of the wine in question, it's reasonable to expect the rating to base off traits of the wine. Therefore, we expect there to be a relationship with one or more of the wine characteristics and its quality. We hypothesized that the strongest relationship would be between quality and flavor, because no one would acclaim a wine they couldn't drink with enjoyment.
